...
Chú ý: Đảm bảo robot đã ở vị trí home trước khi vẽ."""
    ...
    def extract_drawing_path(self, image_path, threshold=128, invert=True, method="contour", detail_level=2):
    ...
    def convert_to_robot_coords(self, drawing_path):
        ...
        # Tỷ lệ chuyển đổi
        scale = self.workspace_size / max(width, height) * 0.55  # thu nhỏ hình một chút
    ...
    def generate_gcode(self):
        ...
        drawing_speed = 1500  # mm/min khi vẽ
